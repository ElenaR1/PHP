...
include_once('user2.php');
	...
	//start validation
		...
		if(empty($_POST['id']))
		{
			$errors['id1']="Полето за ID е празно"; 
		}
...
<html>
	...
	<form action="index2.php" method="POST" target="">
	...
	<p>
	<label for="credits">ID: </label>
	<input type="number" name="id" id="id" min="1" value="<?php if(isset($_POST['id']))  echo $_POST['id']?>" />
	</p>
	<p> <?php
	if (isset($errors['id1']))
	{
