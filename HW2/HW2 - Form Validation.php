<?php
	...
	if($_POST)
	{
		...
		{
			$errors['courseName1']="Полето за името на курса е празно"; 
		}
		if(strlen($_POST['courseName'])>150)
		{
			$errors['courseName2']="Името на курса не може да бъде повече от 150 символа"; 
		}
		...
		{
			$errors['teacherName2']="Името на преподавателя не може да бъде повече от 200 символа"; 
		}
		...
		{
			$errors['description2']="Описанието трябва да бъде повецче от 10 символа";
		}
...
<html>
	...
	value="ОКН">ОКН
	<input type="radio" name="typeOfCourse"<?php if (isset($typeOfCourse) && $typeOfCourse=="ЯКН") echo "checked";?>value="ЯКН">ЯКН	
	
	
	
	</p>
	<p> <?php
	if (isset($errors['typeOfCourse1']))
	{
